...
genus two with CM if one does not use class invariants. The first polynomial
is also printed as H1 in Section 7.2 of [Streng12]. ::
...
Here are the polynomials H_{f}, Hhat_{f,i1}, Hhat_{f,i2} and Hhat_{f,i3} from
Section 8.2.3 of [Streng12], which one would use for constructing curves of genus
two using class invariants. The first polynomial is also printed as Hf in
Section 7.2 of [Streng12].::
