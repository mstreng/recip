...
project = u"CM SageMath code"
copyright = u"2017, Marco Streng"
package_name = "recip"
package_folder = "../../recip"
authors = u"Marco Streng"
...
sys.path.insert(0, os.path.abspath("../..")) #MS added this, it worked in another repository
sys.path.append(os.path.join(SAGE_SRC, "sage_setup", "docbuild", "ext"))


print "!!!???!!!"
print os.path.abspath(package_folder)
print (SAGE_SRC, "sage_setup", "docbuild", "ext")
print (os.path.join(SAGE_SRC, "sage_setup", "docbuild", "ext"))
print "!!!???!!!"
